...
public class Arena implements ActionPreFight {
    ActionPreFight actionPreFight;
    ...
    public void perRoundActions(ArenaFighter arenaFighter1, ArenaFighter arenaFighter2) {
        if (arenaFighter1 instanceof ActionPreFight)
            actionPreFight.addHealth(arenaFighter1.takeDamage(arenaFighter1, arenaFighter2));
        if (arenaFighter2 instanceof ActionPreFight)
            actionPreFight.addHealth(arenaFighter2.takeDamage(arenaFighter1, arenaFighter2));
